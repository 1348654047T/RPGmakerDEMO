 ...
 *
 * @param Left / Right
 * @desc 使用“left”和“right”切换演员？
 * NO - false     YES - true
 * @default true
 *
 * @param PageUp / PageDown
 * @desc 使用“page up”和“down”来切换演员？
 * NO - false     YES - true
 * @default true
 *
 * @param Allow Turn Skip
 * @desc 是否允许回合跳过基于battle的战斗系统？
 * NO - false     YES - true
 * @default true
 *
 * @param ---Front View---
 ...
 *
 * @param X Offset
 * @desc 您希望将actor X的位置偏移多少？
 * @default 24
 *
 * @param Y Offset
 * @desc 您希望将actor X的位置抵消多少？
 * @default -16
 *
 * @help
 * ============================================================================
