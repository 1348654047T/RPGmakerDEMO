 ...
 * -----------------------------------------------------------------------------
 * ----设定注意事项
 * 1.变量框可以在地图和战斗中显示。你需要耐心规划 变量框、boss固定框、
 *   战斗前景 的先后顺序与位置。
 * 2.不流动参数条的长度是原资源图片长度。
 ...
 * 4.参数数值图片会被分割成12份用于字符。除了0-9数字，还有"/"和"x"。
 ...
 * 先确保项目img文件夹下是否有gauge_variable文件夹！（img/gauge_variable）
 * 如果没有，需要自己建立。需要配置资源文件：
 *
 * 样式1 资源-固定框背景 （img/gauge_variable）
 * 样式1 资源-固定框前景 （img/gauge_variable）
 * 样式1 资源-参数数值   （img/gauge_variable）
 * 样式2 ……
 * ……
 *
 * 样式1 参数条 资源-参数条     （img/gauge_meter）
 * 样式1 参数条 资源-参数条遮罩 （img/gauge_meter）
 * 样式1 参数条 资源-凹槽条     （img/gauge_meter）
 * 样式1 参数条 资源-粒子       （img/gauge_meter）
 ...
 * @type struct<GFVStyle>
 * @desc 固定框样式的详细配置信息。
 * @default {"标签":"==计分板样式==","----整体框架----":"","参数条":"","资源-固定框背景":"变量框样式3-框架","平移-固定框背景 X":"0","平移-固定框背景 Y":"0","资源-固定框前景":"","平移-固定框前景 X":"0","平移-固定框前景 Y":"0","----名称显示----":"","是否显示名称":"true","平移-名称 X":"12","平移-名称 Y":"18","名称字体大小":"22","----参数数值----":"","资源-参数数值":"变量框样式1-数值","是否显示参数数值":"true","是否包含最大参数值":"true","平移-参数数值 X":"160","平移-参数数值 Y":"30","参数数值变化速度":"18","参数数值对齐方式":"右对齐","是否显示参数层级数":"false","平移-参数层级数 X":"540","平移-参数层级数 Y":"22","参数层级数对齐方式":"右对齐"}
 *
 * @param 固定框样式-4
 * @parent ---固定框样式---
 * @type struct<GFVStyle>
 * @desc 固定框样式的详细配置信息。
 * @default {"标签":"==进度面板样式==","----整体框架----":"","参数条":"{\"标签\":\"--参数条--\",\"----主体----\":\"\",\"平移-条 X\":\"21\",\"平移-条 Y\":\"39\",\"条整体旋转角度\":\"0\",\"资源-条\":\"变量框样式4-参数条\",\"资源-条遮罩\":\"变量框样式4-参数条遮罩\",\"条层级\":\"1\",\"层级是否循环\":\"false\",\"----缩短效果----\":\"\",\"条是否瞬间缩短\":\"false\",\"缩短速度\":\"2.5\",\"----流动效果----\":\"\",\"条是否流动\":\"true\",\"条流动速度\":\"5.0\",\"----凹槽条----\":\"\",\"是否启用凹槽条\":\"false\",\"资源-凹槽条\":\"\",\"扣除速度\":\"15\",\"扣除方式\":\"缩短扣除\",\"扣除延迟\":\"60\",\"连续减少是否刷新延迟\":\"true\",\"----弹出条----\":\"\",\"是否启用弹出效果\":\"false\",\"弹出条块模式\":\"当前参数条\",\"弹出X速度公式\":\"2*ran -1\",\"弹出Y速度公式\":\"-9 + time*0.9\",\"持续时间\":\"60\",\"----粒子效果----\":\"\",\"是否启用粒子效果\":\"false\",\"资源-粒子\":\"\",\"粒子出现模式\":\"底部出现\",\"粒子流动X速度\":\"0\",\"粒子流动Y速度\":\"-1.5\",\"粒子数量\":\"20\",\"粒子持续时间\":\"20\",\"----游标----\":\"\",\"是否启用游标\":\"false\",\"游标显示模式\":\"一直显示\",\"是否启用多层重置\":\"false\",\"资源-游标\":\"[]\",\"偏移-游标 X\":\"0\",\"偏移-游标 Y\":\"0\",\"动画帧间隔\":\"4\",\"是否倒放\":\"false\"}","资源-固定框背景":"变量框样式4-框架","平移-固定框背景 X":"0","平移-固定框背景 Y":"0","资源-固定框前景":"","平移-固定框前景 X":"0","平移-固定框前景 Y":"0","----名称显示----":"","是否显示名称":"true","平移-名称 X":"15","平移-名称 Y":"5","名称字体大小":"22","----参数数值----":"","资源-参数数值":"变量框样式1-数值","是否显示参数数值":"true","是否包含最大参数值":"true","平移-参数数值 X":"210","平移-参数数值 Y":"16","参数数值变化速度":"18","参数数值对齐方式":"右对齐","是否显示参数层级数":"false","平移-参数层级数 X":"540","平移-参数层级数 Y":"22","参数层级数对齐方式":"右对齐"}
 *
 * @param 固定框样式-5
 * @parent ---固定框样式---
 * @type struct<GFVStyle>
 ...
 * @type number
 * @min 0
 * @desc 地图界面中，该框在地图UI层，图片层级控制相同层下的先后顺序。
 * @default 10
 *
 */
/*~struct~GaugeMeter:
...
// ** ImageManager
//=============================================================================
ImageManager.loadGaugeVariable = function(filename) {
    return this.loadBitmap('img/gauge_variable/', filename, 0, true);
};
...
// * 地图 - 最顶层
//==============================
var _drill_GFV_Scene_createAllWindows = Scene_Map.prototype.createAllWindows;
Scene_Map.prototype.createAllWindows = function() {
	_drill_GFV_Scene_createAllWindows.call(this);
...
// * 地图 - 清除变量框
//==============================
Scene_Map.prototype.drill_removeAllGFVGauge = function() {
...
// * 地图 - 刷新变量框
//==============================
Scene_Map.prototype.drill_refreshGFVGauge = function() {
	...
	//层级排序
	this._drill_SenceTopArea.children.sort(function(a, b){return a.m_zIndex-b.m_zIndex});
}

//==============================
// * 地图 - 帧刷新
//==============================
var _drill_GFV_smap_update = Scene_Map.prototype.updateScene;
...
Spriteset_Battle.prototype.drill_refreshGFVGauge = function() {
	...
	//层级排序
	this._drill_battleUpArea.children.sort(function(a, b){return a.b_zIndex-b.b_zIndex});
}
...
Drill_GFV_StyleSprite.prototype.initialize = function(bind) {
	...
	this._move = 0;
	this.opacity = 0;
	this.b_zIndex = this._drill_bind['b_z_index'];
	this.m_zIndex = this._drill_bind['m_z_index'];
...
Drill_GFV_StyleSprite.prototype.drill_createBackground = function() {
	...
	temp_sprite.bitmap = ImageManager.loadGaugeVariable(this._drill_style['src_background']);
...
Drill_GFV_StyleSprite.prototype.drill_createForeground = function() {
	var temp_sprite = new Sprite();
	temp_sprite.bitmap = ImageManager.loadGaugeVariable(this._drill_style['src_foreground']);
...
Drill_GFV_StyleSprite.prototype.drill_createNumbers = function() {
	// ->hp
	this._drill_num_hp_bitmap = ImageManager.loadGaugeVariable(this._drill_style['num_hp_src']);
