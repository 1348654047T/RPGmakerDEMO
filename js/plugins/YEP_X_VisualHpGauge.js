 ...
 *
 * @param Display Actor
 * @desc 您是否希望为角色展示HP Gauge？
 * NO - false     YES - true
 * @default true
 *
 * @param Defeat First
 * @desc 在显示HP Gauge之前必须先击败敌人。
 * NO - false     YES - true
 * @default false
 *
 * @param Always Visible
 * @desc HP Gauge始终可见，不会消失。
 * NO - false     YES - true
 * @default false
 *
 * @param ---Appearance---
 ...
 * @desc 这是HP仪表的最小宽度（以像素为单位）。
 * @default 144
 *
 * @param Gauge Height
 * @desc 这是HP仪表的高度（以像素为单位）。
 * @default 18
 *
 * @param Back Color
 * @desc 这是用于HP Gauges背面的文本颜色。
 * @default 19
 *
 * @param HP Color 1
 * @desc 这是用于HP Gauges的第一部分的文本颜色。
 * @default 20
 *
 * @param HP Color 2
 * @desc 这是用于HP Gauges第二部分的文本颜色。
 * @default 21
 *
 * @param Gauge Duration
 * @desc 这是HP压力计将继续显示的框架
