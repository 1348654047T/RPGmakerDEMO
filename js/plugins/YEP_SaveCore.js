 ...
 *
 * @param Map Location
 * @desc 用于对"地图位置"进行分类的文本。
 * 留空以不使用此类别并居中数据。
 * @default
 *
 * @param Playtime
 * @desc 用于对"播放时间"进行分类的文本。
 * Leave 空以不使用此类别并居中数据。
 * @default Playtime:
 *
 * @param Save Count
 * @desc 用于对"保存计数"进行分类的文本。
 * Leave empty to not use this category and center the data.
 * @default Total Saves:
 *
 * @param Gold Count
 * @desc 用于对"金币计数"进行分类的文本。
 * Leave empty to not use this category and center the data.
 * @default %1:
 *
 * @param ---Technical---
