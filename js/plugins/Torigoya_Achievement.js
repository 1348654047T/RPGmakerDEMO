 ...
 * @text 弹出字体
 * @desc 指定成就获取弹出显示的字体名称。
 * 如果留为空白，请使用与其他窗口相同的字体。
 * @type string
 * @parent advanced
 * @default
 *
 ...
 * @param key
 * @text 管理ID
 * @desc 获取成就时指定的名称（例如：清除游戏）
 * 数字和中文都可以 / 其他成就和痛苦都是NG
 * @type string
 *
 * @param title
 * @text 表示名
 * @desc 在成就的屏幕上显示时的成就名称
 * （示例：在激烈的战斗结束后击败恶魔王……！）
 * @type string
 * @default
 *
