 ...
 *
 * @param Max Items
 * @desc 最大物品数.如果将其设置为0,则将没有独立物品
 * @default 0
 *
 * @param Max Weapons
 * @desc 最大武器数量.如果将其设置为0,则将没有独立武器
 * @default 100
 *
 * @param Max Armors
 * @desc 最大装甲数量.如果设置为0,则将没有独立装甲.
 * @default 100
 *
 * @param Starting ID
 * @desc 这将是独立物品的起始ID号,这样它们就不会干扰默认物品。
 * @default 3000
 *
 * @param Random Variance
 * @desc 按此值随机化非商店商品的统计信息
 * 可以是正值，也可以是负值.设为0表示不随机。
 * @default 0
 *
 * @param Negative Variance
 * @desc 如果使用随机方差，允许随机方差设备统计值小于0?
 * NO - false     YES - true
 * @default false
 *
 * @param Name Format
 ...
 *
 * @param Carry Format
 * @desc 这是独立物品ID的可视文本格式.
 * %1 - Item Index     %2 - Maximum
 * @default %1/%2
 *
 * @param -Independent Items独立物品--
 * @default
 *
